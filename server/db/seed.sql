INSERT INTO users (username, email, public_key, private_key)
VALUES
  ...
  ('david', 'david@example.com', 'PUBLIC_KEY_DAVID', 'PRIVATE_KEY_DAVID'),
  ('eve', 'eve@example.com', 'PUBLIC_KEY_EVE', 'PRIVATE_KEY_EVE');
